...
/// Required Options: Either url or callback, so the editor knows what to do with the edited values.
    $.fn.editInPlace.defaults = {
        ...
        hover_class:        "sl",  // string: class added to root element during hover. Will override bg_over and bg_out
        show_buttons:        true, // boolean: will show the buttons: cancel or save; will automatically cancel out the onBlur functionality
        save_button:        '<button class="inplace_button button nbutton">Save</button>', // string: image button tag to use as “Save” button
        cancel_button:        '<button class="inplace_button button sbutton">Cancel</button>', // string: image button tag to use as “Cancel” button
        ...
        update_value:        "value", // string: name of parameter holding the updated/edited value
...
// this will always be fixed to the delegate
    ...
    $.extend(InlineEditor.prototype, {
        ...
        inputNameAndClass: function() {
            return ' name="inplace_value" class="inplace_field f" ';
        },
