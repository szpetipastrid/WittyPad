...
(function($) {
    ...
    $.fn.reactTo = function(selector) {
        ...
        $elements.filter('input').bind('change.reactor', _proxy_event);
    ...
    $.fn.reactor = function(options) {
        ...
        this.each(function() {
            ...
            if (!$.isArray($element.data('conditions.reactor'))) {
                $element.data('conditions.reactor', []).addClass('reactor');
            }
    ...
    $.fn.reactor.helpers = {
        ...
        Checked: function(elementId) {
            var _func = function() {
                return ($(elementId).is(':checked') && $(elementId).is(':visible'))
            }
            return _func;
        },

        NotChecked: function(elementId) {
            var _func = function() {
        ...
        NotDisplayed: function(elementId) {
            var _func = function() {
                return (!$(elementId).is(':visible'))
            }
            return _func;
