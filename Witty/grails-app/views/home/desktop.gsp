...
<div style="width: 980px; margin-bottom: 10px;">
    <h1><g:message code="home.content.witty.title"/></h1>
...
<div class="tiles">
    ...
    <div class="tile-row">
        ...
        <div class="small_tile" style="background: url('http://dl.dropbox.com/u/13371372/witty/wiki-tile-small.png')">
    ...
    <div class="tile-row-half">
        <div class="small_tile" style="background: url('http://dl.dropbox.com/u/13371372/witty/faq-tile-small.png')">
            <div class="tile_title">wittypad wiki</div>
