...
<div class="home-content">
    ...
    <div class="tiles">
        ...
        <div class="tile-row">
            <div class="small_tile" style="background: url('http://dl.dropbox.com/u/13371372/twitter-tile-small.png')">
                <div class="tile_title">@wittypad</div>
                <a href="https://twitter.com/#!/wittypad" class="tile_link" target="_blank"></a>
            </div>

            <div class="small_tile" style="background: url('http://dl.dropbox.com/u/13371372/wiki-tile-small.png')">
